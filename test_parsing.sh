...
dir_test_files="parsing/"
test_files="parsing_no_quote parsing_single_quote parsing_double_quote parsing_expand_no_quote parsing_expand_single_quote parsing_expand_double_quote"
EXIT_STATUS=0
...
#awk '{print; print "echo" NR "$?"}' $file > $file'_exit_status'
